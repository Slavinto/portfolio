...
//                 className='dark:bg-background bg-white dark:border-white/[0.2] flex items-center justify-center relative rounded-lg menu-container'
...
//                         console.log(title);
//                         return title === "Sign In" && !!user ? null : (
//                             <div
//                                 className='w-full'
//                                 onClick={() => {
//                                     const el =
